layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function (color) {
		...
		let newcolor = getLightColor(color, 0.916);
		...
		if (newcolor != null) {
			style += '.layui-table tbody tr:hover{background-color:' + newcolor + '!important;}';//增加属性
		}
		style += '.ws-btn-primary{color:' + color + '!important}';
